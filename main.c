...
void alive_structures(int **arr){
	...
	if (choice == 1){
			    ...
			    arr[4][10] = 1; arr[5][11] = 1; arr[5][12] = 1; arr[5][13] = 1; arr[5][14] = 1;
			     arr[4][14] = 1; arr[3][14] = 1; arr[2][13] = 1;  // bus
			}
	else if (choice == 3){
			   arr[9][40] = 1;arr[10][39] = 1;arr[10][41] = 1;arr[11][38] = 1;arr[11][41] = 1;arr[12][39] = 1;arr[12][40] = 1;
    			  ...
    			  arr[4][0]= 1; arr[5][0] = 1; arr[4][1] = 1; arr[5][1] = 1;  arr[4][10] = 1;  arr[5][10] = 1;  arr[6][10] = 1; 
    			  arr[3][11] = 1; arr[7][11] = 1; arr[2][12] = 1;  arr[8][12] = 1;  arr[2][13] = 1;  arr[8][13] = 1; arr[5][14] = 1;
    			  arr[3][15] = 1; arr[7][15] = 1; arr[4][16] = 1; arr[5][16] = 1; arr[6][16] = 1;  arr[5][17] = 1;  arr[2][20] = 1; 
    			  arr[3][20] = 1; arr[4][20] = 1; arr[2][21] = 1; arr[3][21] = 1;
    			  arr[4][21] = 1; arr[1][22] = 1; arr[5][22] = 1; arr[0][24] = 1;  // GLIDER GUN
    			  arr[1][24] = 1; arr[5][24] = 1; arr[6][24] = 1;
    			  arr[2][34] = 1;  arr[3][34] = 1; arr[2][35] = 1; arr[3][35] = 1;
    			 }
    	else{
    			   arr[9][40] = 1;arr[10][39] = 1;arr[10][41] = 1;arr[11][38] = 1;arr[11][41] = 1;arr[12][39] = 1;arr[12][40] = 1;
    			   arr[13][38] = 1;arr[13][41] = 1;arr[14][38] = 1;arr[14][40] = 1;arr[15][39] = 1; // karavai
    			   arr[3][10] = 1; arr[3][11] = 1; arr[3][12] = 1; arr[2][12] = 1; arr[1][11] = 1; // GLIDER
    			   arr[4][10] = 1; arr[5][11] = 1; arr[5][12] = 1; arr[5][13] = 1; arr[5][14] = 1; arr[4][14] = 1;
    			   arr[3][14] = 1; arr[2][13] = 1;  // bus
    			   arr[4][0]= 1; arr[5][0] = 1; arr[4][1] = 1; arr[5][1] = 1;  arr[4][10] = 1;  arr[5][10] = 1;  arr[6][10] = 1; 
    			   arr[3][11] = 1; arr[7][11] = 1; arr[2][12] = 1;  arr[8][12] = 1;  arr[2][13] = 1;  arr[8][13] = 1; arr[5][14] = 1;
    			   arr[3][15] = 1; arr[7][15] = 1; arr[4][16] = 1; arr[5][16] = 1; arr[6][16] = 1;  arr[5][17] = 1;  arr[2][20] = 1; 
    			   arr[3][20] = 1; arr[4][20] = 1; arr[2][21] = 1; arr[3][21] = 1;
